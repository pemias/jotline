...
This guide covers how to set up the development environment and build Jotline from source across different platforms.
...
```bash
git clone git@github.com:pemias/jotline.git
cd jotline
```
